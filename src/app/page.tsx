              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Download and install the Cloudflare Tunnel client for your
                    OS.
                  </p>
                  <a
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Run this command in your terminal and log in via the
                    browser.
                  </p>
                  <pre className="mt-2 rounded-lg bg-muted p-3 text-xs font-mono">
